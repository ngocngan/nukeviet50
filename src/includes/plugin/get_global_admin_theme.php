...
nv_add_hook($module_name, 'get_global_admin_theme', $priority, function ($vars) {
    ...
    if (in_array($module_name, ['upload', 'themes', 'emailtemplates', 'settings', 'seotools', 'modules', 'extensions', 'webtools', 'language', 'siteinfo', 'authors', 'database', 'comment', 'myapi', 'popups'])) {
        return $new_theme;
    }
