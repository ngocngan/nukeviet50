...
$lang_module['dir_note'] = 'Note: The right to left text direction is effective depending on whether the website interface supports it or not. In the admin area, each administrator can choose the text direction as desired';
