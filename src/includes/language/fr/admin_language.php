...
$lang_module['dir'] = 'Sens du texte';
$lang_module['ltr'] = 'De gauche à droite';
$lang_module['rtl'] = 'De droite à gauche';
$lang_module['ltr_preview'] = 'Ceci est un exemple de texte de gauche à droite';
$lang_module['rtl_preview'] = 'Ceci est un exemple de texte de droite à gauche';
$lang_module['dir_note'] = 'Remarque : Le sens du texte de droite à gauche dépend du support de l\'interface du site. Dans la zone d\'administration, chaque administrateur peut choisir le sens du texte selon ses préférences';
