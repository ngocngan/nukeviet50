...
$lang_module['properties_show'] = 'Thuộc tính hiển thị';
$lang_module['number_others'] = 'Giới hạn liên hệ khác';
$lang_module['number_others_help'] = 'Nếu chọn hiển thị liên hệ khác thì giới hạn lại số lượng liên hệ tối đa, 0 là không giới hạn';
