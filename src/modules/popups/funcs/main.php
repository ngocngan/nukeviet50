...
if ($nv_Request->get_int('list', 'get', 0) === 1) {
    ...
    while ($row = $res->fetch()) {
        ...
        $popups[] = [
            ...
            'title' => nv_unhtmlspecialchars($row['title']),
            'description' => nv_unhtmlspecialchars($row['description']),
    ...
    if ($isPreview && !empty($previewRow)) {
        ...
        $popups[] = [
            ...
            'title' => nv_unhtmlspecialchars($previewRow['title']),
            'description' => nv_unhtmlspecialchars($previewRow['description']),
            'content' => nv_unhtmlspecialchars($previewRow['content']),
