...
(3, 'Popup - Chỉ hiện khi đã đăng nhập', 'Ví dụ: đăng nhập mới xem được', '<p>Test: user-only</p>', 'noti', 7, 1, '', 1, '1', 1, 1, 0, 0, " . ($now - 60) . ", 0, '', '_self', 1, 'nv-popups-demo-user-only', " . $now . ", " . $now . ", 1),
(4, 'Popup - Sau mỗi 30 phút', 'Ví dụ: 30 phút hiện lại 1 lần', '<p>Test: every 30 minutes</p>', 'noti', 6, 1, '', 1, '0', 1, 3, 30, 0, " . ($now - 60) . ", 0, '', '_self', 1, 'nv-popups-demo-every-30m', " . $now . ", " . $now . ", 1),
...
(6, 'Popup - Hết hạn', 'Test: đã hết hạn', '<p>Không được trả về</p>', 'noti', 10, 1, '', 1, '0', 1, 2, 0, 0, " . ($now - 86400 * 2) . ", " . ($now - 60) . ", '', '_self', 1, 'nv-popups-demo-expired', " . $now . ", " . ($now - 40) . ", 1),
(7, 'Popup - Chưa tới giờ', 'Test: chưa tới thời điểm', '<p>Không được trả về</p>', 'noti', 10, 1, '', 1, '0', 1, 2, 0, 0, " . ($now + 3600) . ", 0, '', '_self', 1, 'nv-popups-demo-future', " . $now . ", " . ($now - 50) . ", 1),
(8, 'Popup - Bị đình chỉ', 'Test: status=2', '<p>Không được trả về</p>', 'prom', 10, 2, '', 1, '0', 1, 2, 0, 0, " . ($now - 60) . ", 0, '', '_self', 1, 'nv-popups-demo-off', " . $now . ", " . ($now - 60) . ", 1),
(9, 'Popup - Có danh sách trang', 'Test: News (main) + toàn bộ About', '<p>Test lọc trang (news chọn main; about tất cả)</p>', 'prom', 4, 1, '{\"news\":[\"main\"],\"about\":[\"*\"]}', 0, '0', 1, 4, 0, 0, " . ($now - 60) . ", 0, '', '_self', 1, 'nv-popups-demo-pages', " . $now . ", " . ($now - 70) . ", 1),
...
(11, 'Popup - Chỉ khách (ẩn khi login)', 'Ví dụ: chưa đăng nhập thì thấy, đăng nhập thì không thấy', '<p>Test: guest-only</p>', 'prom', 2, 1, '', 1, '2', 1, 4, 0, 0, " . ($now - 60) . ", 0, '', '_self', 1, 'nv-popups-demo-guest-only', " . $now . ", " . $now . ", 1),
(12, 'Popup - Chỉ user (1 lần)', 'Ví dụ: đăng nhập thì thấy 1 lần duy nhất rồi không hiện nữa', '<p>Test: user-only + max_show=1</p>', 'prom', 2, 1, '', 1, '1', 1, 4, 0, 1, " . ($now - 60) . ", 0, '', '_self', 1, 'nv-popups-demo-user-only-2', " . $now . ", " . $now . ", 1),
(13, 'Popup - About (mỗi 2 phút)', 'Test: display_type=3, display_interval=2, chỉ ở About', '<p>Test: every 2 minutes (About)</p>', 'prom', 5, 1, '{\"about\":[\"*\"]}', 0, '0', 1, 3, 2, 0, " . ($now - 60) . ", 0, '', '_self', 1, 'nv-popups-demo-about-2m', " . $now . ", " . $now . ", 1),
(14, 'Popup - News main (mỗi ngày 1 lần)', 'Test: display_type=2, chỉ ở News main', '<p>Test: once per day (News main)</p>', 'prom', 5, 1, '{\"news\":[\"main\"]}', 0, '0', 1, 2, 0, 0, " . ($now - 60) . ", 0, '', '_self', 1, 'nv-popups-demo-news-main-daily', " . $now . ", " . $now . ", 1),
(15, 'Popup - About (1 lần tối đa)', 'Test: display_type=4 + max_show=1, chỉ ở About', '<p>Test: always + max_show=1 (About)</p>', 'prom', 5, 1, '{\"about\":[\"*\"]}', 0, '0', 1, 4, 0, 1, " . ($now - 60) . ", 0, '', '_self', 1, 'nv-popups-demo-about-max1', " . $now . ", " . $now . ", 1);";
