<div class="row mb-3">
    <label class="col-sm-3 col-form-label text-sm-end text-truncate fw-medium">{$LANG->getGlobal('company_name')}:</label>
    <div class="col-sm-9"><input type="text" class="form-control" name="config_company_name" value="{$CONFIG.company_name}"></div>
</div>
<div class="row mb-3">
    <label class="col-sm-3 col-form-label text-sm-end text-truncate fw-medium">{$LANG->getGlobal('company_sortname')}:</label>
    <div class="col-sm-9"><input type="text" class="form-control" name="config_company_sortname" value="{$CONFIG.company_sortname}"></div>
</div>
<div class="row mb-3">
    <label class="col-sm-3 col-form-label text-sm-end text-truncate fw-medium">{$LANG->getGlobal('company_regcode')}:</label>
    <div class="col-sm-9"><input type="text" class="form-control" name="config_company_regcode" value="{$CONFIG.company_regcode}"></div>
</div>
<div class="row mb-3">
    <label class="col-sm-3 col-form-label text-sm-end text-truncate fw-medium">{$LANG->getGlobal('company_regplace')}:</label>
    <div class="col-sm-9"><input type="text" class="form-control" name="config_company_regplace" value="{$CONFIG.company_regplace}"></div>
</div>
<div class="row mb-3">
    <label class="col-sm-3 col-form-label text-sm-end text-truncate fw-medium">{$LANG->getGlobal('company_licensenumber')}:</label>
...
<div class="row mb-3">
    <label class="col-sm-3 col-form-label text-sm-end text-truncate fw-medium">{$LANG->getGlobal('company_responsibility')}:</label>
...
<div class="row">
    <label class="col-sm-3 col-form-label text-sm-end text-truncate fw-medium">{$LANG->getGlobal('company_address')}:</label>
    <div class="col-sm-9">
...
<div id="config_company_maparea"{if empty($CONFIG.company_showmap)} class="d-none"{/if}></div>
    <div class="row mb-3">
        <label class="col-sm-3 col-form-label text-sm-end text-truncate fw-medium">{$LANG->getModule('cominfo_mapurl')}:</label>
        <div class="col-sm-9">
...
<div class="row mb-3">
    <label class="col-sm-3 col-form-label text-sm-end text-truncate fw-medium">{$LANG->getGlobal('company_phone')}:</label>
    <div class="col-sm-9">
...
<div class="row mb-3">
    <label class="col-sm-3 col-form-label text-sm-end text-truncate fw-medium">{$LANG->getGlobal('company_fax')}:</label>
    <div class="col-sm-9"><input type="text" class="form-control" name="config_company_fax" value="{$CONFIG.company_fax}"></div>
</div>
<div class="row mb-3">
    <label class="col-sm-3 col-form-label text-sm-end text-truncate fw-medium">{$LANG->getGlobal('company_email')}:</label>
...
<div class="row mb-3">
    <label class="col-sm-3 col-form-label text-sm-end text-truncate fw-medium">{$LANG->getGlobal('company_website')}:</label>
