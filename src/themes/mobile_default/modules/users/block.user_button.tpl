...
<!-- BEGIN: sso -->
<span><a title="{GLANG.signin} - {GLANG.register}" class="pa pointer button" href="{LINK_LOGIN}" rel="nofollow"><em class="fa fa-user fa-lg pointer mbt-lg"></em><span class="hidden">{GLANG.signin}</span></a></span>
<!-- END: sso -->
