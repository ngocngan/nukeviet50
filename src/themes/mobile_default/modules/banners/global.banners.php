...
if (!nv_function_exists('nv_block_data_config_banners')) {
    ...
    {
        global $db, $language_array, $nv_Lang, $global_config, $site_mods;

        $block_theme = get_tpl_dir([$global_config['module_theme'], $global_config['site_theme']], NV_DEFAULT_SITE_THEME, '/modules/' . $site_mods[$module]['module_theme'] . '/global.banners.config.tpl');
